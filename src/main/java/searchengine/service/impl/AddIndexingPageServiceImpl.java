...
public class AddIndexingPageServiceImpl implements AddIndexingPageService {
    private final static Logger logger = LogManager.getLogger(AddIndexingPageServiceImpl.class);
